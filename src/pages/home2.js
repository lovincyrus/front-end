          ...
          <div className='container'>
            <div className='content-side'>
              ...
              <div className='buttons'>
                <div className='whitepaper cta white' target='_blank' rel='noopener noreferrer' href='https://rawcdn.githack.com/8xprotocol/whitepaper/master/latest.pdf'>
