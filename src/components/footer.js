    ...
    return (
      <div className='navigation-footer-container'>
        ...
        <div className='sections-container'>
          ...
          <div className='footer-section'>
            <h4>Foundation</h4>
            <a style={{color: '#95959A'}} href='https://rawcdn.githack.com/8x-protocol/whitepaper/master/latest.pdf'>Whitepaper</a>
            <a style={{color: '#95959A'}} href='https://github.com/8x-protocol/'>Github</a>
          </div>
        </div>
      </div>
    );
